...
const sportEasyQuestionPairs = [
    ...
    ["Wie heißt das größte Fußballturnier der Welt?", "FIFA-Weltmeisterschaft", ["Fußball", "Basketball", "Tennis"]],
    ["Welche Farbe hat die Karte bei einem Platzverweis im Fußball?", "Rot", ["Blau", "Grün", "Gelb"]],
    ["Wie nennt man ein Unentschieden im Fußball?", "Remis", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Mit welchem Körperteil darf ein Feldspieler im Fußball den Ball normalerweise nicht berühren?", "Mit der Hand", ["Fußball", "Basketball", "Tennis"]],
    ["Wie nennt man den Punktgewinn im Tennis?", "Punkt", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Wie nennt man den Bereich vor dem Tor im Fußball?", "Strafraum", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Welche Sportart fährt man auf Schnee mit zwei Brettern?", "Skifahren", ["Fußball", "Basketball", "Tennis"]],
    ["Wie nennt man einen Treffer im Fußball?", "Tor", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Wie heißt die höchste deutsche Fußballliga?", "Bundesliga", ["Fußball", "Basketball", "Tennis"]],
    ["Welche Sportart verbindet Schwimmen, Radfahren und Laufen?", "Triathlon", ["Fußball", "Basketball", "Tennis"]],
    ["Wie nennt man einen Spieler, der Tore verhindert?", "Torwart", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Wie nennt man die Verlängerung im Fußball?", "Extra Time/Verlängerung", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Welche Farbe hat die Ziellinie im Motorsport meistens?", "Schwarz-Weiß kariert", ["Rot", "Blau", "Grün"]],
    ["Wie nennt man einen Treffer mit dem Kopf im Fußball?", "Kopfballtor", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Welche Sportart nutzt man mit einem Surfbrett?", "Surfen", ["Fußball", "Basketball", "Tennis"]],
    ["Wie nennt man die olympischen Spiele im Winter?", "Winterspiele", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Wie nennt man den besten Torschützen eines Turniers?", "Torschützenkönig", ["Fußball", "Basketball", "Tennis"]],
    ["Welche Sportart wird auf einem Tatami ausgeübt?", "Judo", ["Fußball", "Basketball", "Tennis"]],
    ["Wie viele Minuten dauert ein Basketballspiel in der NBA regulär?", "48", ["38", "43", "53"]],
    ["Welche Sportart spielt man auf Sand oft im Sommer?", "Beachvolleyball", ["Fußball", "Basketball", "Tennis"]],
    ["Wie nennt man ein Rennen mit Hindernissen in der Leichtathletik?", "Hürdenlauf", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Wie nennt man den Start beim Schwimmen?", "Sprungstart", ["Berlin", "Paris", "Wasser"]],
    ...
    ["Wie nennt man den Schiedsrichter im Fußball oft umgangssprachlich?", "Referee/Schiri", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Wie nennt man einen perfekten Wurf im Bowling?", "Strike", ["Berlin", "Paris", "Wasser"]],
    ...
    ["Welche Sportart nutzt einen Helm und ein Pferd?", "Polo", ["Fußball", "Basketball", "Tennis"]],
    ["Wie nennt man den Bereich hinter der Dreierlinie im Basketball?", "Dreipunktbereich", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Wie nennt man einen Sieg ohne Gegentor im Fußball?", "Zu-Null-Sieg", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Welche Sportart nutzt einen Speer?", "Speerwurf", ["Fußball", "Basketball", "Tennis"]],
    ["Wie nennt man den Bereich zum Wechseln im Motorsport?", "Boxengasse", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Wie nennt man den Sieger eines Turniers?", "Champion", ["Fußball", "Basketball", "Tennis"]],
    ["Welche Sportart nutzt ein Snowboard?", "Snowboarden", ["Fußball", "Basketball", "Tennis"]],
    ...
    ["Wie nennt man einen Wurf aus dem Stand im Basketball?", "Standwurf", ["Fußball", "Basketball", "Tennis"]],
    ["Welche Sportart nutzt einen Ring aus Metall am Korb?", "Basketball", ["Eisen", "Gold", "Silber"]],
    ...
    ["Wie nennt man einen Gleichstand nach regulärer Spielzeit?", "Unentschieden", ["Fußball", "Basketball", "Tennis"]],
