...
const sportHardQuestionPairs = [
    ["Wer hält den Rekord für die meisten Tore bei einer FIFA Fußball-Weltmeisterschaft?", "Miroslav Klose"],
    ["Welche Nation gewann die erste UEFA Champions League unter diesem Namen 1993?", "Frankreich gewann nicht; der Sieger war Olympique Marseille"],
    ["Wie viele Runden umfasst das Rennen in Monaco Grand Prix normalerweise?", "78"],
    ["Welcher Tennisspieler gewann als erster 20 Grand-Slam-Titel?", "Roger Federer"],
    ["Welche Nation gewann die erste Rugby-Weltmeisterschaft 1987?", "Neuseeland"],
    ["Wie nennt man im Baseball drei Strikeouts in einem Spielzug?", "Triple Play Strikeout/Immaculate Inning-Kontext"],
    ["Welche Sportart machte Ole Einar Bjørndalen berühmt?", "Biathlon"],
    ["Wer hält den NBA-Rekord für die meisten Punkte in einem Spiel?", "Wilt Chamberlain"],
    ["Wie viele Goldmedaillen gewann Michael Phelps bei Olympischen Spielen?", "23"],
    ["Welche Nation gewann die meisten Titel bei der Copa Libertadores?", "Argentinien"],
    ["Wie heißt die Trophäe der NHL?", "Stanley Cup"],
    ["Welche Nation gewann die erste Fußball-Europameisterschaft 1960?", "Sowjetunion"],
    ["Welche Sportart betreibt Magnus Carlsen professionell?", "Schach"],
    ["Wie viele Spieler dürfen bei einem Fußballspiel maximal auf der Bank sitzen (UEFA-Wettbewerbe meist modern)?", "Unterschiedlich, oft 12–15"],
    ["Welche Nation gewann die meisten olympischen Goldmedaillen im Eiskunstlauf?", "Russland/Sowjetunion"],
    ["Wer gewann die meisten Tour-de-France-Titel offiziell anerkannt?", "5 Fahrer mit je 5 Siegen"],
    ["Welche Sportart nutzt den Begriff „Perfect Game“?", "Baseball"],
    ["Wie viele Punkte erzielte Kobe Bryant in seinem berühmten 81-Punkte-Spiel?", "81"],
    ["Welche Nation gewann die erste Frauenfußball-Weltmeisterschaft?", "USA"],
    ["Wie heißt die höchste Spielklasse im japanischen Fußball?", "J1 League"],
    ["Wer hält den Rekord für die meisten Grand-Slam-Titel im Herrentennis?", "Novak Djokovic"],
    ["Welche Nation gewann die meisten Titel bei der Cricket World Cup?", "Australien"],
    ["Wie lang ist eine olympische Schwimmbahn?", "50 Meter"],
    ["Welche Sportart machte Eddy Merckx berühmt?", "Radsport"],
    ["Wer gewann den ersten Super Bowl?", "Green Bay Packers"],
    ["Welche Nation gewann die erste Basketball-WM der Männer?", "Argentinien"],
    ["Wie nennt man im Darts einen Wurf von 180 Punkten?", "Maximum"],
    ["Welche Sportart nutzt den Begriff „Maillot Jaune“?", "Radsport"],
    ["Wer hält den Rekord für die meisten Formel-1-Weltmeistertitel?", "Lewis Hamilton und Michael Schumacher"],
    ["Welche Nation gewann die erste Handball-Weltmeisterschaft der Männer?", "Deutschland"],
    ["Welche Sportart machte Wayne Gretzky berühmt?", "Eishockey"],
    ["Wie viele Löcher hat ein offizieller Golfplatz standardmäßig?", "18"],
    ["Welche Nation gewann die meisten Titel in der UEFA Champions League?", "Spanien"],
    ["Wer erzielte das „Hand Gottes“-Tor?", "Diego Maradona"],
    ["Welche Sportart nutzt den Begriff „Scrum“?", "Rugby"],
    ["Wie viele Spieler stehen bei einem American-Football-Team gleichzeitig auf dem Feld?", "11"],
    ["Welche Nation gewann die meisten Davis-Cup-Titel?", "USA"],
    ["Wer gewann die erste Formel-1-Weltmeisterschaft?", "Giuseppe Farina"],
    ["Welche Sportart machte Phil Taylor berühmt?", "Darts"],
    ["Wie nennt man im Bowling zwölf Strikes in Folge?", "Perfect Game"],
    ["Welche Nation gewann die erste Rugby-World-Cup-Ausgabe der Frauen?", "USA"],
    ["Wie viele Minuten dauert ein Wasserballspiel regulär?", "32"],
    ["Welche Sportart nutzt den Begriff „Albatross“?", "Golf"],
    ["Wer hält den Rekord für die meisten Tore in der Bundesliga?", "Gerd Müller"],
    ["Welche Nation gewann die meisten olympischen Goldmedaillen im Basketball?", "USA"],
    ["Wie heißt die berühmte Tennisarena in London?", "Centre Court Wimbledon"],
    ["Welche Sportart machte Mika Häkkinen berühmt?", "Formel 1"],
    ["Wie viele Spieler stehen bei einem Curling-Team auf dem Eis?", "4"],
    ["Welche Nation gewann die erste Copa América?", "Uruguay"],
    ["Wie nennt man einen perfekten Satz im Darts?", "Nine-Darter"],
    ["Welche Sportart nutzt den Begriff „Puck Line“?", "Eishockey"],
    ["Wer gewann die meisten olympischen Goldmedaillen im Turnen?", "Larisa Latynina"],
    ["Welche Nation gewann die meisten Stanley Cups?", "Kanada (Montreal Canadiens)"],
    ["Wie viele Punkte erzielt ein Touchdown mit Two-Point-Conversion?", "8"],
    ["Welche Sportart machte Niki Lauda berühmt?", "Formel 1"],
    ["Wie heißt die höchste Basketballliga Europas?", "EuroLeague"],
    ["Welche Nation gewann die erste Fußball-WM der Frauen?", "USA"],
    ["Wer hält den Rekord für die meisten Tore in einer Kalenderjahresaison im Fußball?", "Lionel Messi"],
    ["Welche Sportart nutzt den Begriff „Checkmate“?", "Schach"],
    ["Wie viele Basen gibt es im Baseball?", "4"],
    ["Welche Nation gewann die meisten olympischen Goldmedaillen im Hockey?", "Indien"],
    ["Welche Sportart machte Kelly Slater berühmt?", "Surfen"],
    ["Wie lang ist ein olympisches Schwimmbecken?", "50 Meter"],
    ["Wer gewann die meisten Titel bei den Australian Open der Herren?", "Novak Djokovic"],
    ["Welche Nation gewann die erste Champions-League-Saison?", "Real Madrid aus Spanien"],
    ["Welche Sportart nutzt den Begriff „Fastbreak“?", "Basketball"],
    ["Wie viele Schläger darf ein Golfer maximal mitführen?", "14"],
    ["Welche Sportart machte Valentino Rossi berühmt?", "MotoGP"],
    ["Wer hält den Rekord für die meisten Assists in der NBA?", "John Stockton"],
    ["Welche Nation gewann die erste Volleyball-WM der Männer?", "Sowjetunion"],
    ["Welche Sportart nutzt den Begriff „Century Break“?", "Snooker"],
    ["Wer gewann die meisten Goldmedaillen bei einer einzelnen Olympiade?", "Michael Phelps"],
    ["Welche Nation gewann die erste UEFA Nations League?", "Portugal"],
    ["Wie viele Spieler stehen bei einem Lacrosse-Team auf dem Feld?", "10"],
    ["Welche Sportart machte Babe Ruth berühmt?", "Baseball"],
    ["Wer hält den Rekord für die meisten Pole Positions in der Formel 1?", "Lewis Hamilton"],
    ["Welche Nation gewann die meisten Titel bei der Handball-EM der Männer?", "Schweden"],
    ["Wie nennt man im Tennis einen Satzgewinn ohne Punktverlust des Gegners?", "Golden Set"],
    ["Welche Sportart nutzt den Begriff „Faceoff“?", "Eishockey"],
    ["Wie viele Minuten dauert ein Rugbyspiel regulär?", "80"],
    ["Welche Nation gewann die erste Eishockey-WM?", "Kanada"],
    ["Welche Sportart machte Ayrton Senna berühmt?", "Formel 1"],
    ["Wer hält den Rekord für die meisten Homeruns in der MLB?", "Barry Bonds"],
    ["Welche Nation gewann die meisten olympischen Medaillen insgesamt?", "USA"],
    ["Welche Sportart nutzt den Begriff „Green Jacket“?", "Golf"],
    ["Wie heißt das wichtigste Tennisturnier auf Rasen?", "Wimbledon"],
    ["Welche Sportart machte Haile Gebrselassie berühmt?", "Langstreckenlauf"],
    ["Wie viele Drittel hat ein Eishockeyspiel?", "3"],
    ["Welche Nation gewann die erste Basketball-Olympiagoldmedaille?", "USA"],
    ["Wie nennt man einen direkten Freistoßtreffer im Fußball?", "Freistoßtor"],
    ["Welche Sportart nutzt den Begriff „Safety Car“?", "Formel 1"],
    ["Wer gewann die meisten Ballon-d’Or-Auszeichnungen?", "Lionel Messi"],
    ["Welche Nation gewann die erste Frauen-Handball-WM?", "Südkorea"],
    ["Wie viele Spieler hat ein Cricket-Team?", "11"],
    ["Welche Sportart machte Shaun White berühmt?", "Snowboarden"],
    ["Wer hält den Rekord für die meisten Siege in der Tour de France offiziell?", "Vier Fahrer mit je 5 Siegen offiziell anerkannt"],
    ["Welche Nation gewann die meisten Titel in der Copa América?", "Argentinien und Uruguay"],
    ["Wie nennt man im Baseball einen Schlag aus dem Stadion?", "Homerun"],
    ["Welche Sportart nutzt den Begriff „Butterfly“?", "Schwimmen"],
    ["Wie viele Minuten dauert ein Basketballspiel nach NBA-Regeln?", "48"],
    ["Welche Nation gewann die erste Frauen-Basketball-WM?", "USA"],
    ["Welche Sportart machte Steffi Graf berühmt?", "Tennis"],
    ["Wer hält den Rekord für die meisten Tore in der Champions League?", "Cristiano Ronaldo"],
    ["Welche Nation gewann die meisten Titel im Davis Cup?", "USA"],
    ["Welche Sportart nutzt den Begriff „Knockout Stage“?", "Fußball"],
    ["Wie viele Punkte bringt ein Try im Rugby heute?", "5"],
    ["Welche Sportart machte Conor McGregor berühmt?", "MMA"],
    ["Wer gewann die meisten Weltmeistertitel im Schach offiziell?", "Garry Kasparov / Magnus Carlsen je nach Definition"],
    ["Welche Nation gewann die erste Formel-1-Konstrukteurswertung?", "Vanwall"],
    ["Wie nennt man im Golf ein Ergebnis von zwei unter Par?", "Eagle"],
    ["Welche Sportart nutzt den Begriff „Powerplay“?", "Eishockey und Cricket"],
    ["Welche Nation gewann die meisten olympischen Goldmedaillen im Rudern?", "Großbritannien"],
    ["Wer hält den Rekord für die meisten Tore in einer WM-Endrunde?", "Just Fontaine"],
    ["Welche Sportart machte Serena Williams berühmt?", "Tennis"],
    ["Wie viele Spieler stehen bei einem Polo-Team auf dem Feld?", "4"],
    ["Welche Nation gewann die erste Volleyball-WM der Frauen?", "Sowjetunion"],
    ["Welche Sportart nutzt den Begriff „Red Zone“?", "American Football"],
    ["Wer gewann die meisten Titel bei den French Open?", "Rafael Nadal"],
    ["Welche Nation gewann die meisten olympischen Goldmedaillen im Biathlon?", "Norwegen"],
    ["Wie nennt man einen perfekten Durchgang im Turnen?", "Perfect Score 10"],
    ["Welche Sportart nutzt den Begriff „Breakaway“?", "Eishockey"],
    ["Welche Nation gewann die erste Champions-League-Ausgabe der Frauen?", "Frankfurt"],
    ["Wer hält den Rekord für die meisten Triple-Doubles in der NBA?", "Russell Westbrook"],
    ["Welche Sportart machte Carl Lewis berühmt?", "Leichtathletik"],
    ["Wie viele Minuten dauert ein Handballspiel regulär?", "60"],
    ["Welche Nation gewann die meisten Weltmeistertitel im Volleyball der Männer?", "Sowjetunion"],
    ["Welche Sportart nutzt den Begriff „Bullseye“?", "Darts"],
    ["Wer gewann die meisten Grand-Slam-Titel im Damentennis?", "Margaret Court"],
    ["Welche Nation gewann die erste UEFA Europa League?", "Atlético Madrid gewann die erste unter diesem Namen"],
    ["Wie nennt man einen perfekten Sprung ins Wasser ohne Spritzer?", "Rip Entry/Clean Entry"],
    ["Welche Sportart nutzt den Begriff „Hat Trick“?", "Mehrere, besonders Fußball und Eishockey"],
    ["Welche Nation gewann die meisten olympischen Goldmedaillen im Fechten?", "Italien"],
    ["Wer hält den Rekord für die meisten Punkte in der NBA-Karriere?", "LeBron James"],
    ["Welche Sportart machte Manny Pacquiao berühmt?", "Boxen"],
    ["Wie viele Punkte bringt ein Strike im Bowling ohne Bonus?", "10"],
    ["Welche Nation gewann die erste Rugby-Sevens-Olympiagoldmedaille?", "Fidschi"],
    ["Welche Sportart nutzt den Begriff „Dead Ball“?", "Fußball/Baseball"],
    ["Wer gewann die meisten Formel-1-Rennen?", "Lewis Hamilton"],
    ["Welche Nation gewann die meisten Titel im Männerhockey olympisch?", "Indien"],
    ["Wie nennt man im Tennis einen Rückhandball ohne Spin?", "Slice"],
    ["Welche Sportart nutzt den Begriff „Overtime“?", "Basketball, Football, Hockey"],
    ["Welche Nation gewann die erste Copa-Libertadores-Ausgabe?", "Uruguay (Peñarol)"],
    ["Wer hält den Rekord für die meisten Tore in einer Bundesliga-Saison?", "Gerd Müller"],
    ["Welche Sportart machte Jon Jones berühmt?", "MMA"],
    ["Wie viele Sekunden hat die Shot Clock im FIBA-Basketball?", "24"],
    ["Welche Nation gewann die meisten olympischen Goldmedaillen im Turnen?", "Sowjetunion"],
    ["Welche Sportart nutzt den Begriff „Pinfall“?", "Wrestling"],
    ["Wer gewann die meisten Wimbledon-Titel im Herreneinzel?", "Roger Federer"],
    ["Welche Nation gewann die erste Nations-League-Ausgabe im Volleyball?", "Russland"],
    ["Wie nennt man im Golf einen Schlag ins Wasserhindernis?", "Water Hazard Ball"],
    ["Welche Sportart nutzt den Begriff „Blue Line“?", "Eishockey"],
    ["Welche Nation gewann die meisten Weltmeistertitel im Frauenfußball?", "USA"],
    ["Wer hält den Rekord für die meisten Assists im Fußball international?", "Lionel Messi"],
    ["Welche Sportart machte Sebastian Loeb berühmt?", "Rallye"],
    ["Wie viele Spieler stehen bei einem Baseballspiel insgesamt auf dem Feld?", "18"],
    ["Welche Nation gewann die erste olympische Goldmedaille im Basketball der Frauen?", "Sowjetunion"],
    ["Welche Sportart nutzt den Begriff „Tiebreak“?", "Tennis"],
    ["Wer gewann die meisten Titel bei der Snooker-WM?", "Ronnie O'Sullivan und Stephen Hendry"],
    ["Welche Nation gewann die meisten Titel in der AFC Asian Cup?", "Japan"],
    ["Wie nennt man im Fußball einen Treffer direkt nach Eckball?", "Olimpico"],
    ["Welche Sportart nutzt den Begriff „Match Point“?", "Tennis"],
    ["Welche Nation gewann die meisten olympischen Goldmedaillen im Schwimmen?", "USA"],
    ["Wer hält den Rekord für die meisten Tore in der Premier League?", "Alan Shearer"],
    ["Welche Sportart machte Ronda Rousey berühmt?", "MMA/Judo"],
    ["Wie viele Minuten dauert ein Rugby-League-Spiel?", "80"],
    ["Welche Nation gewann die erste FIFA Klub-Weltmeisterschaft?", "Corinthians"],
    ["Welche Sportart nutzt den Begriff „Double Fault“?", "Tennis"],
    ["Wer gewann die meisten olympischen Goldmedaillen im Sprint?", "Usain Bolt"],
    ["Welche Nation gewann die meisten Titel in der CAF Champions League?", "Ägypten (Al Ahly)"],
    ["Wie nennt man im Basketball einen Dunk mit einer Hand?", "One-Handed Dunk"],
    ["Welche Sportart nutzt den Begriff „Yellow Jersey“?", "Radsport"],
    ["Welche Nation gewann die erste Formel-E-Meisterschaft?", "Brasilien (Nelsinho Piquet als Fahrer)"],
    ["Wer hält den Rekord für die meisten Shutouts in der NHL?", "Martin Brodeur"],
    ["Welche Sportart machte Björn Borg berühmt?", "Tennis"],
    ["Wie viele Minuten dauert ein Wasserballviertel?", "8"],
    ["Welche Nation gewann die meisten Titel im CONCACAF Gold Cup?", "Mexiko"],
    ["Welche Sportart nutzt den Begriff „False Start“?", "Leichtathletik"],
    ["Wer gewann die meisten MotoGP-Weltmeistertitel in der Königsklasse?", "Giacomo Agostini"],
    ["Welche Nation gewann die erste Frauen-Champions-League-Ausgabe?", "Deutschland (Frankfurt)"],
    ["Wie nennt man im Baseball einen Wurf ohne Hit und Run?", "No-Hitter"],
    ["Welche Sportart nutzt den Begriff „Advantage“?", "Tennis"],
    ["Welche Nation gewann die meisten olympischen Goldmedaillen im Ringen?", "Russland/Sowjetunion"],
    ["Wer hält den Rekord für die meisten Punkte in einem NHL-Spiel?", "Darryl Sittler"],
    ["Welche Sportart machte Toni Kroos berühmt?", "Fußball"],
    ["Wie viele Minuten dauert ein Futsalspiel regulär?", "40"],
    ["Welche Nation gewann die erste Basketball-EuroLeague?", "ASK Riga"],
    ["Welche Sportart nutzt den Begriff „Technical Knockout“?", "Boxen"],
    ["Wer gewann die meisten olympischen Goldmedaillen im Skilanglauf?", "Marit Bjørgen"],
    ["Welche Nation gewann die meisten Titel in der OFC Champions League?", "Neuseeland (Auckland City)"],
    ["Wie nennt man im Fußball einen Treffer mit der Hacke?", "Hackentor"],
    ["Welche Sportart nutzt den Begriff „Draft“?", "American Football/Basketball/Baseball"],
    ["Welche Nation gewann die erste Frauen-Volleyball-WM?", "Sowjetunion"],
    ["Wer hält den Rekord für die meisten Siege bei den Olympischen Spielen insgesamt?", "Michael Phelps"],
    ["Welche Sportart machte Didier Drogba berühmt?", "Fußball"],
    ["Wie viele Punkte erzielt ein Three-Point-Play im Basketball maximal in einem Angriff klassisch?", "3"],
    ["Welche Nation gewann die erste moderne Olympiade 1896 im Medaillenspiegel?", "USA"],
    ["Welche Sportart nutzt den Begriff „Power Forward“?", "Basketball"],
    ["Wer gewann die meisten Weltmeistertitel im Formel-1-Teamranking?", "Ferrari"],
    ["Welche Nation gewann die meisten Titel in der UEFA Europa League?", "Spanien"],
...
function getCleanQuestionItemsForDifficulty(difficulty, categoryName) {
    ...
    if (categoryName === "Sport" && difficulty === "medium") {
        return buildQuestionItemsFromPairs(sportMediumQuestionPairs);
    }
